...
public class GPA_Calculator	
{
	public static void main(String[] args)
	{
		...
		int numCredits, numPoints, qualityPoints;
		String courseName;
		...
		String semester = "GPA information for: " + inputSemester + " semester" + "\n";
		...
		do
		{
			...
			numCredits = GetValidNumberInput(inputCredit, 1, 4);
			...
			numPoints = ConvertGradeToPoints(letterGrade);
			...
			qualityPoints = numCredits * numPoints;
	...
	public static void PopUpWindow(String promptStr, String courseName, int numCredits, int numPoints, 
			int qualityPoints, int totalCredits, int totalQualityPoints)
	{
		double GPA = CalculateGPA(totalCredits, totalQualityPoints);
		JOptionPane.showMessageDialog(null, promptStr + "\n"
				+ "\nName of course: " + courseName
				+ "\nNumber of credits for the course: " + numCredits
				+ "\nNumber of grade points earned for the course: " + numPoints
				+ "\nNumber of quality points earned for the course: " + qualityPoints + "\n"
				+ "\nTotal number of credits take: " + totalCredits + " Credits"
				+ "\nTotal quality points earned: " + totalQualityPoints + " Quality Points"
				+ "\nOverall GPA for the semester: " + GPA + " GPA");
	}
}
